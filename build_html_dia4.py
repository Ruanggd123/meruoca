...
<head>
  <meta charset="UTF-8">
  <title>CADERNO OFICIAL DE QUESTÕES — DIA 4 (03/09/2026) | INBRASP</title>
  ...
  <div class="container">
    ...
    <div class="no-print">
      <button class="btn-action" onclick="window.print()">
        <i class="fas fa-print"></i> Imprimir Prova (PDF)
      </button>
    ...
    <div class="header-box">
      <div class="header-titles">
        ...
        <p><strong>Dia 4 (03/09/2026):</strong> Português (15Q) • D. Constitucional (15Q) • Lei Orgânica de Meruoca (10Q)</p>
      </div>
    ...
    <!-- SEÇÃO 1: LÍNGUA PORTUGUESA (15Q) -->
    <div class="section-title">
      <span><i class="fas fa-book"></i> PARTE 1: LÍNGUA PORTUGUESA (QUESTÕES 61 A 75)</span>
      <span style="font-size: 0.8rem; font-weight: normal;">Fonologia, Acentuação Gráfica & Emprego da Crase</span>
    </div>
"""

letters = ['A', 'B', 'C', 'D']

# Gerar questões de Português (61 a 75)
for q in QUESTOES_DIA4[:15]:
    html_template += f"""
...
# SEÇÃO 2: D. CONSTITUCIONAL (15Q)
html_template += """
    <div class="section-title">
      <span><i class="fas fa-scale-balanced"></i> PARTE 2: DIREITO CONSTITUCIONAL (QUESTÕES 76 A 90)</span>
      <span style="font-size: 0.8rem; font-weight: normal;">Arts. 6º ao 11 da CF/88 • Direitos Sociais & Liberdade Sindical</span>
    </div>
"""

for q in QUESTOES_DIA4[15:30]:
    html_template += f"""
    <div class="question-block">
      <div class="question-meta">
        <span class="q-badge">QUESTÃO {q['id']}</span>
...
html_template += """
    <div class="section-title especifica">
      <span><i class="fas fa-landmark"></i> PARTE 3: LEI ORGÂNICA DE MERUOCA (QUESTÕES 91 A 100)</span>
      <span style="font-size: 0.8rem; font-weight: normal;">Arts. 1º ao 15 • Princípios, Autonomia & Competências Privativas</span>
    </div>
"""

for q in QUESTOES_DIA4[30:]:
    html_template += f"""
    <div class="question-block">
      <div class="question-meta">
        <span class="q-badge">QUESTÃO {q['id']}</span>
...
html_template += """
    ...
    <div class="gabarito-section">
      <div style="background: var(--primary); color: white; padding: 10px 16px; border-radius: 6px; font-weight: 800; font-size: 1.1rem; margin-bottom: 16px;">
        <i class="fas fa-check-double"></i> GABARITO OFICIAL FUNDAMENTADO (QUESTÕES 61 A 100)
      </div>
"""
...
with open('provas/CADERNO_QUESTOES_DIA_04_03_09_2026.html', 'w', encoding='utf-8') as f:
    f.write(html_template)

print("[+] Caderno CADERNO_QUESTOES_DIA_04_03_09_2026.html gerado com sucesso!")

...
<head>
  <meta charset="UTF-8">
  <title>CADERNO OFICIAL DE QUESTÕES — SEMANA 2 / DIA 1 (07/09/2026) | INBRASP</title>
  ...
  <div class="container">
    ...
    <div class="header-box">
      <div class="header-titles">
        <span style="font-size: 0.75rem; font-weight: 800; text-transform: uppercase; color: #dc2626;">Caderno de Treino Diário Oficial • Semana 2</span>
        <h1>Câmara Municipal de Meruoca / CE</h1>
        <h2>Concurso Público nº 001/2026 — Cargo: Técnico Legislativo</h2>
        <p><strong>Semana 2 • Dia 1 (07/09/2026):</strong> D. Constitucional: Organização do Estado (20Q) • Português: Estrutura e Formação de Palavras (20Q)</p>
      </div>
    ...
    <!-- SEÇÃO 1: DIREITO CONSTITUCIONAL (20Q) -->
    <div class="section-title">
      <span><i class="fas fa-landmark"></i> PARTE 1: DIREITO CONSTITUCIONAL (QUESTÕES 181 A 200)</span>
      <span style="font-size: 0.8rem; font-weight: normal;">Organização do Estado (CF/88 Arts. 18 a 31: Competências, Municípios e Controle)</span>
    </div>
"""

# Gerar D. Const (181 a 200)
for q in QUESTOES_S2_D1[:20]:
    html_template += f"""
...
# SEÇÃO 2: LÍNGUA PORTUGUESA (20Q)
html_template += """
    <div class="section-title portugues">
      <span><i class="fas fa-spell-check"></i> PARTE 2: LÍNGUA PORTUGUESA (QUESTÕES 201 A 220)</span>
      <span style="font-size: 0.8rem; font-weight: normal;">Estrutura e Processos de Formação de Palavras (Derivação, Composição & Elementos Mórficos)</span>
    </div>
"""
...
html_template += """
    ...
    <div class="gabarito-section">
      <div style="background: var(--primary); color: white; padding: 10px 16px; border-radius: 6px; font-weight: 800; font-size: 1.1rem; margin-bottom: 16px;">
        <i class="fas fa-check-double"></i> GABARITO OFICIAL FUNDAMENTADO (QUESTÕES 181 A 220)
      </div>
"""
...
with open('provas/CADERNO_QUESTOES_SEMANA_02_DIA_01_07_09_2026.html', 'w', encoding='utf-8') as f:
    f.write(html_template)

print("[+] Caderno CADERNO_QUESTOES_SEMANA_02_DIA_01_07_09_2026.html gerado com sucesso!")

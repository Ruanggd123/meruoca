...
let appState = {
  ...
  quizAnswers: {},
  bankVersion: 3,
  quizCategoryFilter: 'reforco_port',
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  selectQuizDay(appState.quizCategoryFilter || 'reforco_port');
  renderFlashcard();
  renderCadernoErros();
  renderSimulados();
  renderDiagnostico();
...
function loadState() {
  ...
  if (saved) {
    try {
      ...
      if (!appState.lastSeenDay || (appState.lastSeenDay !== 'w3_d3' && appState.lastSeenDay !== 'reforco_port')) {
        appState.quizCategoryFilter = 'reforco_port';
        appState.lastSeenDay = 'reforco_port';
      }
...
const QUIZ_DAYS_CONFIG = {
          reforco_port: {
    title: "⭐ REFORÇO HOJE — Português Dia 11 + Dia 14 MESCLADOS (40 Questões)",
  ...
  all: {
    title: "📚 Todas as Questões do Banco de Provas (490 Questões)",
